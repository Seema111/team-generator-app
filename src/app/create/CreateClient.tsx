...
export default function CreateClient({ initialPlayers }: CreateClientProps) {
  ...
  return (
    <div className="fixed top-[10%] left-0 w-full flex justify-center p-4 sm:p-6">
      <div className="w-full max-w-6xl bg-white shadow-lg rounded-lg p-4 sm:p-6 flex flex-col lg:flex-row gap-6">
        <div className="w-full lg:w-1/2">
          <form onSubmit={handleSubmit} className="space-y-4">
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">
              {editIndex !== null ? "Edit Player" : "Add New Player"}
            </h1>
